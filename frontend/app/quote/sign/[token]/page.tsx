          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="mb-6 pb-4 border-b border-gray-100">
                <h3 className="text-sm font-medium text-gray-500 mb-2">Artisan</h3>
                ...
                {quote.artisan.artisanProfile?.siret && (
                  <p className="text-sm text-gray-600">SIRET: {quote.artisan.artisanProfile.siret}</p>
                )}
              ...
              {/* Line items */}
              <div className="mb-6">
                <h3 className="text-sm font-medium text-gray-500 mb-3">Prestations</h3>
              ...
              <div className="mt-6 pt-4 border-t border-gray-100">
                <p className="text-sm text-gray-500">
                  Valide jusqu'au : <span className="font-medium text-gray-700">{formatDate(quote.validUntil)}</span>
                </p>
