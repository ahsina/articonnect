  ...
  async create(createInvoiceDto: CreateInvoiceDto) {
    ...
    const invoice = await this.prisma.invoice.create({
      data: {
        ...
        lineItems: createInvoiceDto.lineItems as Prisma.InputJsonValue,
        issuerAddress: createInvoiceDto.issuerAddress as Prisma.InputJsonValue,
        clientAddress: createInvoiceDto.clientAddress as Prisma.InputJsonValue,
